...
#define led_setup_on()      do {  } while (0)
#define led_setup_off()     do {  } while (0)
#define led_connect_on()    do {  } while (0)
#define led_connect_off()   do {  } while (0)

#define ble_reset_high()    do { PORTB |= 0x10; } while(0)
#define ble_reset_low()     do { PORTB &= ~(0x10); } while (0)
#define reqn_set_high()     do { PORTB |= 0x01; } while (0)
#define reqn_set_low()      do { PORTB &= ~(0x01); } while (0)
#define rdyn_is_high()      (PINB & 0x08)
#define rdyn_is_low()       (!(PINB & 0x08))
